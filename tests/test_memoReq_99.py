...
@pytest.mark.usefixtures("bag_ids", "memo_99")
class TestMemoReq99(BaseClass):

    def test_memo99(self, bag_ids, memo_99):
        log = self.get_logger()
        log.info("Testing scenario of submitting a memo with 99 characters")
        ...
        log.info("Adding memo size of 99")
        profile.set_memo(memo_99)
