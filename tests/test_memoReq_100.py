...
@pytest.usefixtures("bag_ids", "memo_100")
class TestMemoReq100(BaseClass):

    def test_memo100(self, bag_ids, memo_100):
        log = self.get_logger()
        log.info("Testing scenario of submitting a memo with 100 characters")
        ...
        log.info("Adding memo size of 100")
        profile.set_memo(memo_100)
        ...
        log.error("Memo size is too large to submit FAIL")
